...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { amount: @institution.amount, end: @institution.end, loan: @institution.loan, name: @institution.name, start: @institution.start, user_id: @institution.user_id } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { amount: @institution.amount, end: @institution.end, loan: @institution.loan, name: @institution.name, start: @institution.start, user_id: @institution.user_id } }
