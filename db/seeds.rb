...
@savings_array = ["1234567890","348897660","1234229890","2987990237"]
@occupation_array = ["Self-Employed","Employed","Unemployed","Contract"]
@address_array = ["20 Mulberry Road, Off Jericho Plaza",
                  "12 Aluguntugut street, Ambassadorial Enclave Accra",
                  "89 Broadway road, Langtang Avenue",
                  "43 Mimi complex,Indomie Street,Noodles Avenue"]

@expenditures_array = ["Rent","Transportation","Utility","Feeding","Laundry"]
...
5.times  do
        ...
        user_pending = User.create!(
                    ...
                    address: @address_array[selector],
                    remote_image_url:(@image_ary.sample).to_s
             )
       
       random_amount = rand(20...1000)
      ...
      4.times do
        ...
        user_pending.employments.create(
            status: @occupation_array[selector],
            start: DateTime.now - rand(1...10).years,
            average_income: unless @occupation_array[selector] == "Unemployed"; rand(30000...120000); end 
              )

        6.times do
        user_pending.dailups.create(
            called_at: DateTime.now - rand(1...50).days,
